...
function gold(filter) {
	function perLevel(levelMin, goldHide, goldWisdom, goldAugment, goldAugmentExalt) {
		filter.block((c, e) => {
			...
			c.count = new Comparison(goldHide, OPERATOR.LT);
		...
		filter.block((c, e) => {
			...
			c.categories(CATEGORY.CURRENCY);
			c.names = new Comparison("Gold");
			c.count = new Comparison(goldWisdom, OPERATOR.LT);
		...
		filter.block((c, e) => {
			...
			c.categories(CATEGORY.CURRENCY);
			c.names = new Comparison("Gold");
			c.count = new Comparison(goldAugment, OPERATOR.LT);
		...
		filter.block((c, e) => {
			...
			c.categories(CATEGORY.CURRENCY);
			c.names = new Comparison("Gold");
			c.count = new Comparison(goldAugmentExalt, OPERATOR.LT);
