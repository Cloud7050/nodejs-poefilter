...
export class NameManager {
	...
	static getGear(cOrStringList = null, valueMin = undefined, valueMax = undefined, dropLevel = null, dropLevelOperator = undefined) {
		...
		let nameManager = new NameManager(
			...
			new Name("Splintered Tower Shield", 1, CATEGORY.SHIELD_AM, 0),
			new Name("Painted Tower Shield", 1, CATEGORY.SHIELD_AM, 6),
			new Name("Braced Tower Shield", 1, CATEGORY.SHIELD_AM, 12),
			new Name("Barricade Tower Shield", 1, CATEGORY.SHIELD_AM, 16),
			new Name("Effigial Tower Shield", 1, CATEGORY.SHIELD_AM, 21),
			new Name("Rampart Tower Shield", 1, CATEGORY.SHIELD_AM, 28),
			new Name("Heraldric Tower Shield", 1, CATEGORY.SHIELD_AM, 33),
			new Name("Stone Tower Shield", 1, CATEGORY.SHIELD_AM, 36),
			new Name("Crucible Tower Shield", 1, CATEGORY.SHIELD_AM, 45),
			new Name("Ancestor Tower Shield", 1, CATEGORY.SHIELD_AM, 50),
			new Name("Bulwark Tower Shield", 1, CATEGORY.SHIELD_AM, 54),
			new Name("Noble Tower Shield", 1, CATEGORY.SHIELD_AM, 59),
			new Name("Goldworked Tower Shield", 1, CATEGORY.SHIELD_AM, 61),
			new Name("Royal Tower Shield", 1, CATEGORY.SHIELD_AM, 65),
			new Name("Fortress Tower Shield", 1, CATEGORY.SHIELD_AM, 70),
			new Name("Vaal Tower Shield", 1, CATEGORY.SHIELD_AM, 75),
			new Name("Tawhoan Tower Shield", 5, CATEGORY.SHIELD_AM, 80),

			new Name("Hardwood Targe", 1, CATEGORY.SHIELD_AM_EV, 0),
			new Name("Pelage Targe", 1, CATEGORY.SHIELD_AM_EV, 8),
			new Name("Studded Targe", 1, CATEGORY.SHIELD_AM_EV, 16),
			new Name("Crescent Targe", 1, CATEGORY.SHIELD_AM_EV, 26),
			new Name("Chiseled Targe", 1, CATEGORY.SHIELD_AM_EV, 33),
			new Name("Feathered Targe", 1, CATEGORY.SHIELD_AM_EV, 37),
			new Name("Stratified Targe", 1, CATEGORY.SHIELD_AM_EV, 46),
			new Name("Carved Targe", 1, CATEGORY.SHIELD_AM_EV, 51),
			new Name("Polished Targe", 1, CATEGORY.SHIELD_AM_EV, 54),
			new Name("Stone Targe", 1, CATEGORY.SHIELD_AM_EV, 59),
			new Name("Avian Targe", 1, CATEGORY.SHIELD_AM_EV, 62),
			new Name("Mammoth Targe", 1, CATEGORY.SHIELD_AM_EV, 65),
			new Name("Baroque Targe", 1, CATEGORY.SHIELD_AM_EV, 70),
			new Name("Soaring Targe", 1, CATEGORY.SHIELD_AM_EV, 75),
			new Name("Golden Targe", 5, CATEGORY.SHIELD_AM_EV, 80),

			new Name("Blazon Crest Shield", 1, CATEGORY.SHIELD_AM_ES, 0),
			new Name("Sigil Crest Shield", 1, CATEGORY.SHIELD_AM_ES, 7),
			new Name("Emblem Crest Shield", 1, CATEGORY.SHIELD_AM_ES, 16),
			new Name("Jingling Crest Shield", 1, CATEGORY.SHIELD_AM_ES, 28),
			new Name("Sectarian Crest Shield", 1, CATEGORY.SHIELD_AM_ES, 33),
			new Name("Omen Crest Shield", 1, CATEGORY.SHIELD_AM_ES, 36),
			new Name("Wayward Crest Shield", 1, CATEGORY.SHIELD_AM_ES, 45),
			new Name("Seer Crest Shield", 1, CATEGORY.SHIELD_AM_ES, 50),
			new Name("Dekharan Crest Shield", 1, CATEGORY.SHIELD_AM_ES, 54),
			new Name("Quartered Crest Shield", 1, CATEGORY.SHIELD_AM_ES, 59),
			new Name("Glowering Crest Shield", 1, CATEGORY.SHIELD_AM_ES, 62),
			new Name("Intricate Crest Shield", 1, CATEGORY.SHIELD_AM_ES, 65),
			new Name("Sekheman Crest Shield", 1, CATEGORY.SHIELD_AM_ES, 70),
			new Name("Vaal Crest Shield", 1, CATEGORY.SHIELD_AM_ES, 75),
			new Name("Blacksteel Crest Shield", 5, CATEGORY.SHIELD_AM_ES, 80),
			...
			new Name("Rusted Greathelm", 1, CATEGORY.HELMET_AM, 0),
			new Name("Soldier Greathelm", 1, CATEGORY.HELMET_AM, 12),
			new Name("Wrapped Greathelm", 1, CATEGORY.HELMET_AM, 16),
			new Name("Spired Greathelm", 1, CATEGORY.HELMET_AM, 27),
			new Name("Elite Greathelm", 1, CATEGORY.HELMET_AM, 33),
			new Name("Warrior Greathelm", 1, CATEGORY.HELMET_AM, 36),
			new Name("Commander Greathelm", 1, CATEGORY.HELMET_AM, 45),
			new Name("Fierce Greathelm", 1, CATEGORY.HELMET_AM, 51),
			new Name("Elegant Greathelm", 1, CATEGORY.HELMET_AM, 54),
			new Name("Noble Greathelm", 1, CATEGORY.HELMET_AM, 59),
			new Name("Warmonger Greathelm", 1, CATEGORY.HELMET_AM, 65),
			new Name("Masked Greathelm", 1, CATEGORY.HELMET_AM, 70),
			new Name("Paragon Greathelm", 1, CATEGORY.HELMET_AM, 75),
			new Name("Imperial Greathelm", 5, CATEGORY.HELMET_AM, 80),

			new Name("Shabby Hood", 1, CATEGORY.HELMET_EV, 0),
			new Name("Felt Cap", 1, CATEGORY.HELMET_EV, 10),
			new Name("Lace Hood", 1, CATEGORY.HELMET_EV, 16),
			new Name("Swathed Cap", 1, CATEGORY.HELMET_EV, 26),
			new Name("Hunter Hood", 1, CATEGORY.HELMET_EV, 33),
			new Name("Viper Cap", 1, CATEGORY.HELMET_EV, 38),
			new Name("Corsair Cap", 1, CATEGORY.HELMET_EV, 45),
			new Name("Leatherbound Hood", 1, CATEGORY.HELMET_EV, 50),
			new Name("Wrapped Cap", 1, CATEGORY.HELMET_EV, 54),
			new Name("Deerstalker Hood", 1, CATEGORY.HELMET_EV, 59),
			new Name("Woven Cap", 1, CATEGORY.HELMET_EV, 65),
			new Name("Desert Cap", 1, CATEGORY.HELMET_EV, 70),
			new Name("Trapper Hood", 1, CATEGORY.HELMET_EV, 75),
			new Name("Freebooter Cap", 5, CATEGORY.HELMET_EV, 80),
			...
			new Name("Brimmed Helm", 1, CATEGORY.HELMET_AM_EV, 5),
			new Name("Guarded Helm", 1, CATEGORY.HELMET_AM_EV, 11),
			new Name("Visored Helm", 1, CATEGORY.HELMET_AM_EV, 16),
			new Name("Cowled Helm", 1, CATEGORY.HELMET_AM_EV, 26),
			new Name("Shielded Helm", 1, CATEGORY.HELMET_AM_EV, 33),
			new Name("Closed Helm", 1, CATEGORY.HELMET_AM_EV, 45),
			new Name("Cabalist Helm", 1, CATEGORY.HELMET_AM_EV, 54),
			new Name("Warded Helm", 1, CATEGORY.HELMET_AM_EV, 65),
			new Name("Cryptic Helm", 1, CATEGORY.HELMET_AM_EV, 70),
			new Name("Champion Helm", 1, CATEGORY.HELMET_AM_EV, 75),
			new Name("Gladiatorial Helm", 5, CATEGORY.HELMET_AM_EV, 80),

			new Name("Iron Crown", 1, CATEGORY.HELMET_AM_ES, 5),
			new Name("Horned Crown", 1, CATEGORY.HELMET_AM_ES, 10),
			new Name("Cultist Crown", 1, CATEGORY.HELMET_AM_ES, 16),
			new Name("Martyr Crown", 1, CATEGORY.HELMET_AM_ES, 28),
			new Name("Heavy Crown", 1, CATEGORY.HELMET_AM_ES, 33),
			new Name("Spiritbone Crown", 1, CATEGORY.HELMET_AM_ES, 45),
			new Name("Hallowed Crown", 1, CATEGORY.HELMET_AM_ES, 54),
			new Name("Inquisitor Crown", 1, CATEGORY.HELMET_AM_ES, 59),
			new Name("Druidic Crown", 1, CATEGORY.HELMET_AM_ES, 65),
			new Name("Saintly Crown", 1, CATEGORY.HELMET_AM_ES, 70),
			new Name("Divine Crown", 1, CATEGORY.HELMET_AM_ES, 75),
			new Name("Cryptic Crown", 5, CATEGORY.HELMET_AM_ES, 80),

			new Name("Hewn Mask", 1, CATEGORY.HELMET_EV_ES, 5),
			new Name("Face Mask", 1, CATEGORY.HELMET_EV_ES, 10),
			new Name("Hooded Mask", 1, CATEGORY.HELMET_EV_ES, 16),
			new Name("Veiled Mask", 1, CATEGORY.HELMET_EV_ES, 28),
			new Name("Tribal Mask", 1, CATEGORY.HELMET_EV_ES, 33),
			new Name("Solid Mask", 1, CATEGORY.HELMET_EV_ES, 45),
			new Name("Pariah Mask", 1, CATEGORY.HELMET_EV_ES, 54),
			new Name("Avian Mask", 1, CATEGORY.HELMET_EV_ES, 59),
			new Name("Brigand Mask", 1, CATEGORY.HELMET_EV_ES, 65),
			new Name("Faridun Mask", 1, CATEGORY.HELMET_EV_ES, 70),
			...
			new Name("Raider Plate", 1, CATEGORY.BODY_AM, 16),
			new Name("Maraketh Cuirass", 1, CATEGORY.BODY_AM, 20),
			new Name("Steel Plate", 1, CATEGORY.BODY_AM, 27),
			new Name("Full Plate", 1, CATEGORY.BODY_AM, 33),
			new Name("Vaal Cuirass", 1, CATEGORY.BODY_AM, 37),
			new Name("Juggernaut Plate", 1, CATEGORY.BODY_AM, 45),
			new Name("Chieftain Cuirass", 1, CATEGORY.BODY_AM, 50),
			new Name("Elegant Plate", 1, CATEGORY.BODY_AM, 54),
			new Name("Heavy Plate", 1, CATEGORY.BODY_AM, 59),
			new Name("Stone Cuirass", 1, CATEGORY.BODY_AM, 62),
			new Name("Ornate Plate", 5, CATEGORY.BODY_AM, 70), // 445 AM, Regenerate 1.5–2.5% of maximum Life per second
			new Name("Utzaal Cuirass", 5, CATEGORY.BODY_AM, 75), // 445 AM, 30–40% increased Stun Threshold

			new Name("Soldier Cuirass", 10, CATEGORY.BODY_AM, 65), // 534 AM
			new Name("Warlord Cuirass", 10, CATEGORY.BODY_AM, 80), // 445 AM, +15–25% of Armour also applies to Elemental Damage

			new Name("Leather Vest", 1, CATEGORY.BODY_EV, 0),
			new Name("Quilted Vest", 1, CATEGORY.BODY_EV, 4),
			new Name("Pathfinder Coat", 1, CATEGORY.BODY_EV, 11),
			new Name("Shrouded Vest", 1, CATEGORY.BODY_EV, 16),
			new Name("Rhoahide Coat", 1, CATEGORY.BODY_EV, 22),
			new Name("Studded Vest", 1, CATEGORY.BODY_EV, 26),
			new Name("Scout's Vest", 1, CATEGORY.BODY_EV, 33),
			new Name("Serpentscale Coat", 1, CATEGORY.BODY_EV, 36),
			new Name("Corsair Vest", 1, CATEGORY.BODY_EV, 45),
			new Name("Smuggler Coat", 1, CATEGORY.BODY_EV, 51),
			new Name("Layered Vest", 1, CATEGORY.BODY_EV, 54),
			new Name("Runner Vest", 1, CATEGORY.BODY_EV, 59),
			new Name("Lizardscale Coat", 1, CATEGORY.BODY_EV, 62),
			new Name("Swiftstalker Coat", 5, CATEGORY.BODY_EV, 65), // 406 EV, 20–30% reduced Slowing Potency of Debuffs on You
			new Name("Wyrmscale Coat", 5, CATEGORY.BODY_EV, 75), // 406 EV, 30–40% increased Elemental Ailment Threshold

			new Name("Slipstrike Vest", 10, CATEGORY.BODY_EV, 70), // 487 EV
			new Name("Corsair Coat", 20, CATEGORY.BODY_EV, 80), // 406 EV, 5% increased Movement Speed
			...
			new Name("Chain Mail", 1, CATEGORY.BODY_AM_EV, 0),
			new Name("Rogue Armour", 1, CATEGORY.BODY_AM_EV, 11),
			new Name("Vagabond Armour", 1, CATEGORY.BODY_AM_EV, 16),
			new Name("Cloaked Mail", 1, CATEGORY.BODY_AM_EV, 26),
			new Name("Explorer Armour", 1, CATEGORY.BODY_AM_EV, 33),
			new Name("Scale Mail", 1, CATEGORY.BODY_AM_EV, 37),
			new Name("Knight Armour", 1, CATEGORY.BODY_AM_EV, 45),
			new Name("Ancestral Mail", 1, CATEGORY.BODY_AM_EV, 50),
			new Name("Mantled Mail", 1, CATEGORY.BODY_AM_EV, 54),
			new Name("Trailblazer Armour", 1, CATEGORY.BODY_AM_EV, 59),
			new Name("Golden Mail", 1, CATEGORY.BODY_AM_EV, 62),
			new Name("Dastard Armour", 1, CATEGORY.BODY_AM_EV, 65), // 245 AM, 223 EV, +60–80 to maximum Life
			new Name("Shrouded Mail", 1, CATEGORY.BODY_AM_EV, 70), // 245 AM, 223 EV, +20–25% to Fire/Cold/Lightning Resistance
			new Name("Thane Mail", 1, CATEGORY.BODY_AM_EV, 80), // 245 AM, 223 EV, Hits against you have 15–25% reduced Critical Damage Bonus
			new Name("Death Mail", 5, CATEGORY.BODY_AM_EV, 75), // 294 AM, 268 EV

			new Name("Pilgrim Vestments", 1, CATEGORY.BODY_AM_ES, 0),
			new Name("Pelt Mantle", 1, CATEGORY.BODY_AM_ES, 10),
			new Name("Mail Vestments", 1, CATEGORY.BODY_AM_ES, 16),
			new Name("Shaman Mantle", 1, CATEGORY.BODY_AM_ES, 28),
			new Name("Ironclad Vestments", 1, CATEGORY.BODY_AM_ES, 33),
			new Name("Sacrificial Mantle", 1, CATEGORY.BODY_AM_ES, 36),
			new Name("Cleric Vestments", 1, CATEGORY.BODY_AM_ES, 45),
			new Name("Tideseer Mantle", 1, CATEGORY.BODY_AM_ES, 51),
			new Name("Occultist Mantle", 1, CATEGORY.BODY_AM_ES, 54),
			new Name("Plated Vestments", 1, CATEGORY.BODY_AM_ES, 59),
			new Name("Heartcarver Mantle", 1, CATEGORY.BODY_AM_ES, 62),
			new Name("Conjurer Mantle", 1, CATEGORY.BODY_AM_ES, 70), // 245 AM, 84 ES, +20–30 to Spirit
			new Name("Death Mantle", 1, CATEGORY.BODY_AM_ES, 75), // 245 AM, 84 ES, +1% to all Maximum Elemental Resistances
			new Name("Seastorm Mantle", 1, CATEGORY.BODY_AM_ES, 80), // 245 AM, 84 ES, 8–14% of Damage taken Recouped as Life
			new Name("Wolfskin Mantle", 5, CATEGORY.BODY_AM_ES, 65), // 294 AM, 101 ES

			new Name("Hermit Garb", 1, CATEGORY.BODY_EV_ES, 0),
			new Name("Waxed Jacket", 1, CATEGORY.BODY_EV_ES, 11),
			new Name("Marabout Garb", 1, CATEGORY.BODY_EV_ES, 16),
			new Name("Wayfarer Jacket", 1, CATEGORY.BODY_EV_ES, 28),
			new Name("Anchorite Garb", 1, CATEGORY.BODY_EV_ES, 33),
			new Name("Scalper's Jacket", 1, CATEGORY.BODY_EV_ES, 39),
			new Name("Scoundrel Jacket", 1, CATEGORY.BODY_EV_ES, 45),
			new Name("Ascetic Garb", 1, CATEGORY.BODY_EV_ES, 51),
			new Name("Itinerant Jacket", 1, CATEGORY.BODY_EV_ES, 54),
			new Name("Hatungo Garb", 1, CATEGORY.BODY_EV_ES, 59),
			new Name("Hawker's Jacket", 1, CATEGORY.BODY_EV_ES, 62),
			new Name("Austere Garb", 1, CATEGORY.BODY_EV_ES, 80), // 223 EV, 84 ES, 10–15% reduced Elemental Ailment Duration on you
			new Name("Rambler Jacket", 5, CATEGORY.BODY_EV_ES, 70), // 223 EV, 84 ES, +7–13% to Chaos Resistance
			...
			new Name("Riveted Mitts", 1, CATEGORY.GLOVES_AM, 11),
			new Name("Tempered Mitts", 1, CATEGORY.GLOVES_AM, 16),
			new Name("Bolstered Mitts", 1, CATEGORY.GLOVES_AM, 27),
			new Name("Moulded Mitts", 1, CATEGORY.GLOVES_AM, 33),
			new Name("Detailed Mitts", 1, CATEGORY.GLOVES_AM, 45),
			new Name("Ancient Mitts", 1, CATEGORY.GLOVES_AM, 54),
			new Name("Feathered Mitts", 1, CATEGORY.GLOVES_AM, 59),
			new Name("Knightly Mitts", 1, CATEGORY.GLOVES_AM, 65),
			new Name("Ornate Mitts", 1, CATEGORY.GLOVES_AM, 70),
			new Name("Vaal Mitts", 1, CATEGORY.GLOVES_AM, 75),
			new Name("Massive Mitts", 5, CATEGORY.GLOVES_AM, 80),

			new Name("Suede Bracers", 1, CATEGORY.GLOVES_EV, 0),
			new Name("Firm Bracers", 1, CATEGORY.GLOVES_EV, 11),
			new Name("Bound Bracers", 1, CATEGORY.GLOVES_EV, 16),
			new Name("Sectioned Bracers", 1, CATEGORY.GLOVES_EV, 28),
			new Name("Spined Bracers", 1, CATEGORY.GLOVES_EV, 33),
			new Name("Fine Bracers", 1, CATEGORY.GLOVES_EV, 45),
			new Name("Refined Bracers", 1, CATEGORY.GLOVES_EV, 54),
			new Name("Spiked Bracers", 1, CATEGORY.GLOVES_EV, 59),
			new Name("Stalking Bracers", 1, CATEGORY.GLOVES_EV, 65),
			new Name("Grand Bracers", 1, CATEGORY.GLOVES_EV, 70),
			new Name("Barbed Bracers", 1, CATEGORY.GLOVES_EV, 75),
			new Name("Polished Bracers", 5, CATEGORY.GLOVES_EV, 80),
			...
			new Name("Ringmail Gauntlets", 1, CATEGORY.GLOVES_AM_EV, 6),
			new Name("Layered Gauntlets", 1, CATEGORY.GLOVES_AM_EV, 16),
			new Name("Doubled Gauntlets", 1, CATEGORY.GLOVES_AM_EV, 33),
			new Name("Plate Gauntlets", 1, CATEGORY.GLOVES_AM_EV, 45),
			new Name("Zealot Gauntlets", 1, CATEGORY.GLOVES_AM_EV, 59),
			new Name("Steelmail Gauntlets", 1, CATEGORY.GLOVES_AM_EV, 65),
			new Name("Commander Gauntlets", 1, CATEGORY.GLOVES_AM_EV, 70),
			new Name("Cultist Gauntlets", 1, CATEGORY.GLOVES_AM_EV, 75),
			new Name("Blacksteel Gauntlets", 5, CATEGORY.GLOVES_AM_EV, 80),

			new Name("Rope Cuffs", 1, CATEGORY.GLOVES_AM_ES, 5),
			new Name("Aged Cuffs", 1, CATEGORY.GLOVES_AM_ES, 16),
			new Name("Goldcast Cuffs", 1, CATEGORY.GLOVES_AM_ES, 33),
			new Name("Verisium Cuffs", 1, CATEGORY.GLOVES_AM_ES, 45),
			new Name("Ornate Cuffs", 1, CATEGORY.GLOVES_AM_ES, 59),
			new Name("Bound Cuffs", 1, CATEGORY.GLOVES_AM_ES, 65),
			new Name("Ancient Cuffs", 1, CATEGORY.GLOVES_AM_ES, 70),
			new Name("Gleaming Cuffs", 1, CATEGORY.GLOVES_AM_ES, 75),
			new Name("Adherent Cuffs", 5, CATEGORY.GLOVES_AM_ES, 80),

			new Name("Gauze Wraps", 1, CATEGORY.GLOVES_EV_ES, 4),
			new Name("Linen Wraps", 1, CATEGORY.GLOVES_EV_ES, 16),
			new Name("Spiral Wraps", 1, CATEGORY.GLOVES_EV_ES, 33),
			new Name("Buckled Wraps", 1, CATEGORY.GLOVES_EV_ES, 45),
			new Name("Adorned Wraps", 1, CATEGORY.GLOVES_EV_ES, 59),
			new Name("War Wraps", 1, CATEGORY.GLOVES_EV_ES, 65),
			new Name("Elegant Wraps", 1, CATEGORY.GLOVES_EV_ES, 70),
			new Name("Vaal Wraps", 1, CATEGORY.GLOVES_EV_ES, 75),
			new Name("Secured Wraps", 5, CATEGORY.GLOVES_EV_ES, 80),

			// https://poe2db.tw/us/Boots#BootsItem
			new Name("Rough Greaves", 1, CATEGORY.BOOTS_AM, 0),
			new Name("Iron Greaves", 1, CATEGORY.BOOTS_AM, 11),
			new Name("Bronze Greaves", 1, CATEGORY.BOOTS_AM, 16),
			new Name("Trimmed Greaves", 1, CATEGORY.BOOTS_AM, 27),
			new Name("Stone Greaves", 1, CATEGORY.BOOTS_AM, 33),
			new Name("Reefsteel Greaves", 1, CATEGORY.BOOTS_AM, 45),
			new Name("Elegant Greaves", 1, CATEGORY.BOOTS_AM, 54),
			new Name("Carved Greaves", 1, CATEGORY.BOOTS_AM, 59),
			new Name("Bulwark Greaves", 1, CATEGORY.BOOTS_AM, 65),
			new Name("Ornate Greaves", 1, CATEGORY.BOOTS_AM, 70),
			new Name("Vaal Greaves", 1, CATEGORY.BOOTS_AM, 75),
			new Name("Tasalian Greaves", 5, CATEGORY.BOOTS_AM, 80),

			new Name("Rawhide Boots", 1, CATEGORY.BOOTS_EV, 0),
			new Name("Laced Boots", 1, CATEGORY.BOOTS_EV, 11),
			new Name("Embossed Boots", 1, CATEGORY.BOOTS_EV, 16),
			new Name("Steeltoe Boots", 1, CATEGORY.BOOTS_EV, 28),
			new Name("Lizardscale Boots", 1, CATEGORY.BOOTS_EV, 33),
			new Name("Flared Boots", 1, CATEGORY.BOOTS_EV, 45),
			new Name("Studded Boots", 1, CATEGORY.BOOTS_EV, 54),
			new Name("Serpentscale Boots", 1, CATEGORY.BOOTS_EV, 59),
			new Name("Cinched Boots", 1, CATEGORY.BOOTS_EV, 65),
			new Name("Cavalry Boots", 1, CATEGORY.BOOTS_EV, 70),
			new Name("Dragonscale Boots", 1, CATEGORY.BOOTS_EV, 75),
			new Name("Drakeskin Boots", 5, CATEGORY.BOOTS_EV, 80),
			...
			new Name("Mail Sabatons", 1, CATEGORY.BOOTS_AM_EV, 6),
			new Name("Braced Sabatons", 1, CATEGORY.BOOTS_AM_EV, 16),
			new Name("Stacked Sabatons", 1, CATEGORY.BOOTS_AM_EV, 33),
			new Name("Covered Sabatons", 1, CATEGORY.BOOTS_AM_EV, 45),
			new Name("Bastion Sabatons", 1, CATEGORY.BOOTS_AM_EV, 59),
			new Name("Veteran Sabatons", 1, CATEGORY.BOOTS_AM_EV, 65),
			new Name("Noble Sabatons", 1, CATEGORY.BOOTS_AM_EV, 70),
			new Name("Fortress Sabatons", 1, CATEGORY.BOOTS_AM_EV, 75),
			new Name("Blacksteel Sabatons", 5, CATEGORY.BOOTS_AM_EV, 80),

			new Name("Padded Leggings", 1, CATEGORY.BOOTS_AM_ES, 5),
			new Name("Secured Leggings", 1, CATEGORY.BOOTS_AM_ES, 16),
			new Name("Pelt Leggings", 1, CATEGORY.BOOTS_AM_ES, 33),
			new Name("Weaver Leggings", 1, CATEGORY.BOOTS_AM_ES, 45),
			new Name("Shamanistic Leggings", 1, CATEGORY.BOOTS_AM_ES, 59),
			new Name("Faithful Leggings", 1, CATEGORY.BOOTS_AM_ES, 65),
			new Name("Apostle Leggings", 1, CATEGORY.BOOTS_AM_ES, 70),
			new Name("Warlock Leggings", 1, CATEGORY.BOOTS_AM_ES, 75),
			new Name("Cryptic Leggings", 5, CATEGORY.BOOTS_AM_ES, 80),

			new Name("Frayed Shoes", 1, CATEGORY.BOOTS_EV_ES, 5),
			new Name("Threaded Shoes", 1, CATEGORY.BOOTS_EV_ES, 16),
			new Name("Hunting Shoes", 1, CATEGORY.BOOTS_EV_ES, 33),
			new Name("Steelpoint Shoes", 1, CATEGORY.BOOTS_EV_ES, 45),
			new Name("Treerunner Shoes", 1, CATEGORY.BOOTS_EV_ES, 59),
			new Name("Wanderer Shoes", 1, CATEGORY.BOOTS_EV_ES, 65),
			new Name("Charmed Shoes", 1, CATEGORY.BOOTS_EV_ES, 70),
			new Name("Quickslip Shoes", 1, CATEGORY.BOOTS_EV_ES, 75),
			new Name("Daggerfoot Shoes", 5, CATEGORY.BOOTS_EV_ES, 80),
