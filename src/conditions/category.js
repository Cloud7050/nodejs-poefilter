...
const HELMET_CLASS = new StringList(HELMET_EV, HELMET_ES, HELMET_EV_ES);
const BODY_CLASS = new StringList(BODY_EV, BODY_ES, BODY_EV_ES);
const GLOVES_CLASS = new StringList(GLOVES_EV, GLOVES_ES, GLOVES_EV_ES);
const BOOTS_CLASS = new StringList(BOOTS_EV, BOOTS_ES, BOOTS_EV_ES);
